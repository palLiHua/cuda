 ...
 *
 * Use -D to define macro. Including SINGLE_PREC or DOUBLE_PREC to indicate 
 * using float or double type. VALIDATE to check on host.
 * 
 **/
...
{
    int i;
    int N = 30720;  // number of particles
    int block = 256;
    int iter, niters = 50;
    real *d_px, *d_py;
    real *d_vx, *d_vy;
